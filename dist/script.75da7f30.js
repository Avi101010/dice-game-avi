...
btnRoll.addEventListener('click', function () {
  if (playing) {
    ...
    console.log(dice); //display dice

    diceEl.classList.remove('hidden');
    diceEl.src = "dice-".concat(dice, ".png"); //check for roll 1 , if true switch to next player
...
btnHold.addEventListener('click', function () {
  if (playing) {
    ...
    document.getElementById("score--".concat(activePlayer)).textContent = scores[activePlayer]; //check score is >=100
